...
Jalon M3 complet (voir `MILESTONES.md`) : `realSection` est le plongement ℝ-linéaire
...
Milestone M3 complete (see `MILESTONES.md`): `realSection` is the ℝ-linear embedding
