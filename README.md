...
## Citer ce travail
Version citable recommandée : tag `v1.0.2-gleason`, commit
`8347fcf26a0344461f27311e5c6c05e95626da5e`
(https://github.com/Bobart0/gleason-theorem-lean/tree/v1.0.2-gleason). `setup.sh`
reconstruit cette version à l'identique (voir « Démarrage » ci-dessus).
...
## Citing this work
Recommended citable version: tag `v1.0.2-gleason`, commit
`8347fcf26a0344461f27311e5c6c05e95626da5e`
(https://github.com/Bobart0/gleason-theorem-lean/tree/v1.0.2-gleason). `setup.sh`
rebuilds this version identically (see "Getting started" above).
